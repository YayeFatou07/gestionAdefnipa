...
$sql = "SELECT * FROM etudiant WHERE niveau = 'M2' ORDER BY (modul1 + modul2 + modul3 + modul4) / 4 DESC ";
$result = $conn->query($sql);

/*$sql = "SELECT id, nom, prenom, date_naissance, email, telephone, niveau, modul1, modul2, modul3, modul4, statut, 
        (modul1 + modul2 + modul3 + modul4) / 4 AS moyenne
        FROM etudiant where niveau = 'L1' ORDER BY moyenne DESC";*/
            ...
            <section class="middle-section">
                <div class="whitebox-table">
                    <div class="table__title__row">
                        <div class="title">Liste des Étudiants en M2</div>
                    </div>
